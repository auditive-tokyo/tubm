...
export function initializeVideoLightbox($) {
        // prettyPhotoが読み込まれるのを待つ
        const waitForPrettyPhoto = () => {
        ...
        waitForPrettyPhoto().then(() => {
                ...
                console.warn('PrettyPhoto initialization delayed:', error);
        });
}
